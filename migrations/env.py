...
Resolves the database URL from the application Settings (so credentials stay in
.env) and targets the ORM metadata from ``quantbot.infrastructure.db`` for
...
from quantbot.infrastructure.db import models  # noqa: F401 - register all tables
